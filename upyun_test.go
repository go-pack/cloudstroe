...
func init() {
	bucket := os.Getenv("upyun::bucket")
	operator := os.Getenv("upyun::operator")
	password := os.Getenv("upyun::password")
	domain := strings.ToLower(os.Getenv("upyun::domain"))
	secret := strings.ToLower(os.Getenv("upyun::secret"))
