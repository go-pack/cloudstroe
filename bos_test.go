...
func init() {
	...
	key := os.Getenv("bos::accessKey")
	secret := os.Getenv("bos::secretKey")
	endpoint := os.Getenv("bos::endpoint")
	bucket := os.Getenv("bos::bucket")
	domain := strings.ToLower(os.Getenv("bos::domain"))
