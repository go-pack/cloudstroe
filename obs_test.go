...
func init() {
	accessKey := os.Getenv("obs::accessKey")
	secretKey := os.Getenv("obs::secretKey")
	bucket := os.Getenv("obs::bucket")
	endpoint := os.Getenv("obs::endpoint")
	domain := os.Getenv("obs::domain")
